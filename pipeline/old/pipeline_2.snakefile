...
rule qc_and_merge:
    ...
    shell:
        ...
        {params.pipeline_dir}/filter_merge_1.sh \
            -p {params.input_dir} \
            -m {params.metadata} \
            -t {params.threads}
        """
...
rule rtd_embedding:
    ...
    shell:
        ...
        {params.pipeline_dir}/generate_rtd_2.sh \
            -b {params.base_dir} \
            -i {params.input_dir} \
...
rule cgr_embedding:
    ...
    shell:
        ...
        {params.pipeline_dir}/generate_cgr_2.sh \
            -b {params.base_dir} \
            -i {params.input_dir} \
            -p {params.pipeline_dir} \
            -m {params.metadata} \
...
rule rtd_clustering:
    ...
    shell:
        ...
        python {params.pipeline_dir}/cluster_1.py \
...
rule merge_clusters:
    ...
    shell:
        ...
        python {params.pipeline_dir}/merge_1.py \
...
rule rtd_bootstrapping:
    ...
    shell:
        ...
        python {params.pipeline_dir}/bootstrap_2.py \
...
rule rtd_sleuth:
    ...
    shell:
        ...
        Rscript {params.pipeline_dir}/sleuth_1.R \
            --root "$base_path" \
